...
## O que eu aprendi?
Aprendi conceitos fundamentais sobre um banco de dados  e sobre como o SQL é usado na criação de tabelas. Além disso, aprendi a usar a ferramenta MySQL Workbench para praticar os comandos SQL.
