...
SELECT * FROM payment WHERE payment_date BETWEEN '2005/05/01' AND '2005/08/01' ORDER BY payment_date;
SELECT title, release_year, rental_duration FROM film WHERE rental_duration BETWEEN 3 AND 6 ORDER BY rental_duration DESC, title ASC;
